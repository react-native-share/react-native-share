...
To use `react-native-share` simply run a:
...
If you have any doubt about, want to check how handle `Share.open` or other methods, please give a look at our docs at: https://react-native-community.github.io/react-native-share/

# Contributing Guide

Also, if you want to help us with issues, or new stuff please fell free to look at our [Contributing Guide](https://react-native-community.github.io/react-native-share/docs/contributing)