...
This is historical migration guidance. For current releases on Android API 19 or
later, app-specific cache files do not require this permission. Follow the
[current installation instructions](installing.mdx) instead.
